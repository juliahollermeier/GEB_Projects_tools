Paula Martínez and Júlia Hollermeier  
...
This seminar has proven highly beneficial for the upcoming development of our Final Degree Project (TFG) and the initial proposal (avant-projecte). The core value lay in mastering GitHub as a collaborative platform, allowing all team members to track, modify, and review code in real time. Furthermore, gaining hands-on experience in sensor programming has provided us with the essential technical foundation required for our project’s implementation.
